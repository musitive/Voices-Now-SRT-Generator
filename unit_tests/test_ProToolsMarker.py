...
class TestTimecode(unittest.TestCase):
    ...
    def test_init_valid(self):
        ...
        self.assertEqual(self.marker1.timecode, Timecode.from_total_frames("00:00:39:12", 24.0))
        ...
        self.assertEqual(self.marker2.timecode, Timecode.from_total_frames("00:00:48:19", 24.0))
        ...
        self.assertEqual(self.marker3.timecode, Timecode.from_total_frames("00:00:56:22", 24.0))
